...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Brand red reads on both themes; everything else is a CSS variable that
        // flips in .dark (see globals.css), expressed as an RGB triplet so
        // opacity modifiers (text-ink/70) keep working.
